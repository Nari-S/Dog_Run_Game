...
internal class LeftFlickInteraction : IInputInteraction
{
    ...
    {
        InputSystem.RegisterInteraction<LeftFlickInteraction>();
    }
    ...
    public void Process(ref InputInteractionContext context)
    {
        ...
        if(touchInfo.delta.magnitude > minFlickDistance)
        {
            ...
            if (Mathf.Abs(angleAxisToVector) < 135) return; //-135<θ<135 で左フリックとする．
