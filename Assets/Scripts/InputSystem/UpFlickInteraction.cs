...
internal class UpFlickInteraction : IInputInteraction
{
    ...
    {
        InputSystem.RegisterInteraction<UpFlickInteraction>();
    }
    ...
    public void Process(ref InputInteractionContext context)
    {
        ...
        if(touchInfo.delta.magnitude > minFlickDistance)
        {
            ...
            if (!(45 <= angleAxisToVector && angleAxisToVector <= 135)) return; //45<=θ<=135 で上フリックとする．
